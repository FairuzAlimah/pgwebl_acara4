    ...
    <script>
        ...
        var polyline = L.geoJson(null, {
            onEachFeature: function(feature, layer) {
                ...
                /// memasukkan polyline ke dalam drawnItems
                drawnItems.addLayer(layer); // memindahkan layer
                ...
                layer.on({
                    click: function(e) {
                        ...
                        // Gunakan direktori image secara dinamis
                        $('#preview-image-polyline').attr(
                            'src',
                            '/storage/images/' + properties.image
                        );
        ...
        var polyline = L.geoJson(null, {
            ...
            onEachFeature: function(feature, layer) {
                ...
                var properties = feature.properties;
                layer.on({
                    click: function(e) { // menampilkan data ke dalam modal
                        $('#name').val(properties.name);
                        $('#description').val(properties.description);
                        $('#geom_polyline').val(objectGeometry);
